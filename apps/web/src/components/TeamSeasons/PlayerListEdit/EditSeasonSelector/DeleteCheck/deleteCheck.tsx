...
export default function DeleteCheck({deletedObj, deletedObjId, setDeleteCheck}: DeleteCheckProps) {
    ...
    return(
        <div className="deleteCheck">
            ...
            <button onClick={() => {deleteObj()}}>Yes</button>
            <button onClick={() => {setDeleteCheck(false)}}>No, go back</button>
        </div>
    )
}