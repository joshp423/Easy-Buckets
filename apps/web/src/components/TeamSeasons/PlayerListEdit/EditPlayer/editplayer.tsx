    ...
    return (
        <div className="editPlayer">
            <form onSubmit={confirmPlayerEdit}>
                ...
                <input onChange={(e) => {setPlayerName(e.target.value)}} type="text" name="playerName" value={editPlayer.name}/>
                <label htmlFor="playerName">Edit Player Number: </label>
                <input onChange={(e) => {setPlayerNumber(Number(e.target.value))}} type="number" name="playerName" value={editPlayer.number}/>
